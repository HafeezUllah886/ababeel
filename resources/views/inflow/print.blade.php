    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="800" class="w320">
          ...
          <tr>
            <td >
            <h4 style="text-transform: uppercase">Receiving Vouchare</h4>
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                <tr>
                                  <td class="mini-block">
                                    <span class="header-sm">Received From</span><br />
                                    {{ $bill->supplier->title }}
                                    <br />
                                    <br />
                                    <span class="header-sm">Contact #</span> <br />
                                    {{ $bill->supplier->contact }}
                                  </td>
                                </tr>
                              </table>
                        </td>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: right; border-top: 1px solid #cccccc;">
                      <span class="total-space"> {{ round($total) }}</span> <br />
