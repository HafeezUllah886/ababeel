    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="800" class="w320">
          ...
          <tr>
            <td >
            <h4 style="text-transform: uppercase">Stock Details</h4>
            </td>
          </tr>
          <tr>
            <td class="w320">
                        ...
                        <td class="mini-block-padding">
                            <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                <tr>
                                  ...
                                  <td class="mini-block">
                                    <span class="header-sm">Code: </span> {{ $product->code }}<br />
                                    <span class="header-sm">Color: </span> {{ $product->color }}<br />
                                    <span class="header-sm">Size: </span> {{ round($product->width,2) }} X {{ round($product->length,2) }}<br />
                                  </td>
                                </tr>
                              </table>
                        </td>
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">From: </span>{{ $from }}<br />
                                <span class="header-sm">To: </span>{{ $to }}<br />
                                <span class="header-sm">Previous Balance: </span> {{ $p_balance }}<br />
                                <span class="header-sm">Current Stock: </span> {{ $c_balance }}<br />
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="item-col" style="text-align: right">
                        {{ $item->cr == null ? '-' : round($item->cr,2)}}
                    </td>
                    <td class="item-col" style="text-align: right">
                        {{ $item->db == null ? '-' : round($item->db,2)}}
                    </td>
                    <td class="item-col" style="text-align: right">
                        {{ round($bal,2) }}
                       </td>
